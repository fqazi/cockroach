...
- package path
- understanding artifact path (`$TMPDIR/bug-catcher/<sanitized-package-path>/understanding.md`)
- output path: `$TMPDIR/bug-catcher/<sanitized-package-path>/candidates.md`
